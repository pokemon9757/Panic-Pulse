...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""GameActions"",
            ""id"": ""36dafa30-e8eb-43f5-9d53-87bc74edf0dd"",
            ""actions"": [
                {
                    ""name"": ""Decrease HR"",
                    ""type"": ""Button"",
                    ""id"": ""ff6248a0-b4a6-4c86-a552-58b414d88f83"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Increase HR"",
                    ""type"": ""Button"",
                    ""id"": ""1108900d-87e2-4ee8-b7c3-3748b3f0f39d"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""146a71a0-073a-42ab-901a-4c79cba06233"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9bad2164-cea4-4c57-a42f-b23c2187299c"",
    ...
    ""controlSchemes"": [
        ...
        m_GameActions_DecreaseHR = m_GameActions.FindAction("Decrease HR", throwIfNotFound: true);
        m_GameActions_IncreaseHR = m_GameActions.FindAction("Increase HR", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_GameActions_DecreaseHR;
    private readonly InputAction m_GameActions_IncreaseHR;
    public struct GameActionsActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public GameActionsActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @DecreaseHR => m_Wrapper.m_GameActions_DecreaseHR;
        public InputAction @IncreaseHR => m_Wrapper.m_GameActions_IncreaseHR;
        ...
        public void AddCallbacks(IGameActionsActions instance)
        {
            ...
            @DecreaseHR.started += instance.OnDecreaseHR;
            @DecreaseHR.performed += instance.OnDecreaseHR;
            @DecreaseHR.canceled += instance.OnDecreaseHR;
            @IncreaseHR.started += instance.OnIncreaseHR;
            @IncreaseHR.performed += instance.OnIncreaseHR;
            @IncreaseHR.canceled += instance.OnIncreaseHR;
        }
    ...
    {
        void OnDecreaseHR(InputAction.CallbackContext context);
        void OnIncreaseHR(InputAction.CallbackContext context);
    }
}
